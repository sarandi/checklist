...
*** Interaction Design
**** Are all dynamic/motion/AJAX areas working?
**** cursor pointers  
...
*** Check format (user/search engine friendliness) of URLs (use %20 or + to replace spaces)	 
*** Set up Analytics, FeedBurner, and any other packages for measuring ongoing success	 
*** Use rel="" coupled with jQuery/gAnalytics to track downloads and in-page/AJAX events http://bit.ly/UBaT6w  
